...
const HolidayBanner = ({ mode }: HolidayBannerProps) => {
  if (mode === "christmas") {
    return (
      <div className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-red-700 via-red-600 to-green-700 py-2 px-4 overflow-hidden">
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-purple-700 via-blue-600 to-indigo-700 py-2 px-4 overflow-hidden">
      <div className="container mx-auto flex items-center justify-center gap-3">
